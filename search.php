...
<html>
    ...
    <form action="search.php" method="post" >
        ...
        <input type="hidden" name="search_select" value = <?=$_POST['search_select']?> >
        ...
        <input type="submit" class = "css_btn_class" value = "OK"> 
         ...
         <a href="logout.php" class="css_btn2_class">Log out</a>
           <a href="flight.php" class="css_btn3_class">End search</a>
		  ...
		  <?php
			if($_SESSION['account'] != null)
			{
				...
				while ($result = $sth->fetchObject()) 
				{
					...
					//$squal = "SELECT * FROM `flight` WHERE $search = ? ";
					//$st = $db->prepare($squal);
					//$st->execute(array($key));
					//$result3 = $st->fetchObject();
